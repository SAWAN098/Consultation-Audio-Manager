    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md fade-in-up">
        <div className="text-center mb-8">
          ...
          <p className="text-cream/60 mt-2 text-sm">Sign in to manage your consultation recordings</p>
        </div>
        ...
        >
          ...
          <p className="text-center text-cream/50 text-sm mt-5">
            New here?{' '}
            <Link to="/register" className="text-gold-soft hover:text-gold transition-colors">
              Create an account
            </Link>
          </p>
        </form>
